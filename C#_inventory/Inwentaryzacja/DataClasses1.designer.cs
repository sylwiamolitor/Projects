...
namespace Inwentaryzacja
{
	...
	partial void Ontyp_zleceniaChanging(string value);
	partial void Ontyp_zleceniaChanged();
    ...
    partial void OnPomieszczenie_ID_pomieszczeniaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage = "_typ_zlecenia", DbType = "VarChar(1)")]
		public string typ_zlecenia
		{
			get
			{
				return this._typ_zlecenia;
			}
			set
			{
				if ((this._typ_zlecenia != value))
				{
					this.OnstanChanging(value);
					this.SendPropertyChanging();
					this._typ_zlecenia = value;
					this.SendPropertyChanged("typ_zlecenia");
					this.OnstanChanged();
				}
			}
		}
	...
	public partial class Pomieszczenie : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _Katedra_ID_katedry;
    ...
    partial void OnKatedra_ID_katedryChanging(System.Nullable<int> value);
    ...
    partial void OnWydział_ID_wydziałuChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Katedra_ID_katedry", DbType = "Int")]
		public System.Nullable<int> Katedra_ID_katedry
		{
			get
			{
    ...
    partial void Onnumer_inwentaryzacyjnyChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Pomieszczenie_ID_pomieszczenia", DbType = "Int NOT NULL IDENTITY")]
		public int Pomieszczenie_ID_pomieszczenia
		{
			get
			{
